...
/**
 * Class to represent every item in plan
 * 
 * @author horodysk
 */
public class PlanObject implements Serializable {
    ...
    /***/
    public PlanObject(String time, String title, String place, String lecturer, String type, int day, int week, int startHour) {
        super();
        _time = time;
        _title = title;
        _place = place;
